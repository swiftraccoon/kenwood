...
pub(crate) fn render(frame: &mut Frame<'_>) {
    ...
    let lines = vec![
        ...
        binding("c/s/S/a/d/g/m/F", "Switch view"),
        Line::from(""),
        header("Channel List"),
        binding("j/k", "Navigate"),
        binding("g / G", "First / last"),
        binding("Enter", "Tune target band"),
        binding("e", "Edit channel (freq/mode/name)"),
        ...
        Line::from(""),
        header("APRS"),
        binding("a", "Toggle APRS mode (on APRS panel)"),
        binding("j/k", "Navigate station list"),
        binding("M", "Compose message to station"),
        binding("b", "Manual beacon"),
        Line::from(""),
        header("GPS"),
        binding("g", "Toggle GPS on/off (on GPS panel)"),
        binding("p", "Toggle PC output (on GPS panel)"),
        Line::from(""),
        header("D-STAR"),
        binding("d", "Toggle D-STAR gateway mode (on D-STAR panel)"),
        binding("C", "Set CQ (URCALL = CQCQCQ)"),
        binding("u", "Set URCALL (prompt)"),
        binding("r", "Prepare reflector link (prompt)"),
        binding("U", "Prepare reflector unlink"),
        Line::from(""),
        header("FM Radio"),
        binding("F", "Switch to FM Radio panel"),
        binding("f", "Toggle FM on/off (on FM panel)"),
        Line::from(""),
        header("MCP"),
